...
instrument.serial.timeout = 0.3 # seconds
...
value = instrument.read_register(4050, 0, 4)
...
value = instrument.read_register(4100, 0, 4)
filterStateEnum = { 0: 'cisty', 1: 'spinavy' }
print('Stav filtru:', filterStateEnum[value])

value = instrument.read_register(4060, 0, 4)
...
value = instrument.read_register(6033, 0, 3)
imbalanceEnum = { 0: 'nepovolena', 1: 'povolena' }
print('Nevyvazenost:', imbalanceEnum[value])

value = instrument.read_register(6035, 0, 3)
print('Odchylka nevyvazenosti privodu:', value, '%')

value = instrument.read_register(6036, 0, 3)
